...
func GenerateConfig(site *store.Website, useSSL bool, certName string) string {
	...
	writeServerBlock(&b, site, serverName, useSSL, certName)
...
func writeServerBlock(b *strings.Builder, site *store.Website, serverName string, useSSL bool, certName string) {
